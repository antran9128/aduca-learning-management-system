    ...
    <div class="page-content">
      ...
      <div class="card">
        <div class="card-body p-4">
          ...
          <form:form id="myForm" action="/admin/smtp/update" method="post" class="row g-3" enctype="multipart/form-data" modelAttribute="smpt">

            <form:input type="hidden" path="id"/>

            <div class="form-group col-md-6">
              <label for="input1" class="form-label">	Mailer</label>
              <form:input type="text" path="host" class="form-control" id="input1"/>
            </div>

            <div class="form-group col-md-6">
              <label for="input1" class="form-label">	Host</label>
              <form:input type="text" path="port" class="form-control" id="input1" />
            </div>
            <div class="form-group col-md-6">
              <label for="input1" class="form-label">	Port</label>
              <form:input type="text" path="username" class="form-control" id="input1"/>
            </div>
            <div class="form-group col-md-6">
              <label for="input1" class="form-label">	Password</label>
              <form:input type="text" path="password" class="form-control" id="input1"/>
            </div>
