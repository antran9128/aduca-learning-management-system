        ...
        <div class="card-body p-4">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <form id="myForm" action="/admin/search/by/date" method="post" class="row g-3" enctype="multipart/form-data">
            ...
            <div class="col-md-4">
              <form id="myForm" action="/admin/search/by/month" method="post" class="row g-3" enctype="multipart/form-data">
                <input type="hidden" name="${_csrf.parameterName}"
                       value="${_csrf.token}" />
                <div class="form-group col-md-12">
            ...
            <div class="col-md-4">
              ...
              <form id="myForm" action="/admin/search/by/year" method="post" class="row g-3" enctype="multipart/form-data">
                <input type="hidden" name="${_csrf.parameterName}"
                       value="${_csrf.token}" />
                <div class="form-group col-md-12">
                  <label for="input1" class="form-label">Search By Year</label>
