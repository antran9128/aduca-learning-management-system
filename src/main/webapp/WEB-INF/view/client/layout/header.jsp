                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul class="cat-dropdown-menu">
                                                      <c:forEach var="category" items="${globalCategories}" varStatus="status">
                                                        <li>
                                                          <a href="/category/${category.id}/${category.categorySlug}">${category.categoryName}<i class="la la-angle-right"></i></a>
                                                          <ul class="sub-menu">
                                                            <c:forEach var="sub" items="${category.subCategories}" varStatus="status">
                                                              <li><a href="/subcategory/${sub.id}/${sub.subcategorySlug}">${sub.subcategoryName}</a></li>
                                                            </c:forEach>
                                                          </ul>
                                                        </li>
                                                      </c:forEach>
                                            ...
                                            <ul class="cart-dropdown-menu">
                                              ...
                                              <li class="media media-card">
                                                <div class="media-body fs-16">
                                                  <p class="text-black font-weight-semi-bold lh-18">Total: <span class="cart-total" id="cartSubTotal">0</span></p>
                                                </div>
                                              </li>
                                              <li>
                                                <a href="/mycart" class="btn theme-btn w-100">Go to cart <i class="la la-arrow-right icon ml-1"></i></a>
                                              </li>
                                            </ul>
                                          </li>
                                        </ul>
