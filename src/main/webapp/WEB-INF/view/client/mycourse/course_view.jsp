    ...
    <div class="container-fluid">
      <div class="main-menu-content d-flex align-items-center">
        ...
        <div class="course-dashboard-header-title pl-4">
          <a href="course-details.html" class="text-white fs-15">${course.courseName}</a>
                ...
                <div class="lecture-overview-wrap">
                  ...
                  <div class="lecture-overview-item">
                    <div class="lecture-overview-stats-wrap d-flex">
                      ...
                      <div class="lecture-overview-stats-item">
                        <ul class="generic-list-item">
                          <li><span>Resourse:</span>${course.resources}</li>
                ...
                <div class="lecture-overview-wrap lecture-quest-wrap">
                  <div class="new-question-wrap">
                    ...
                    <div class="new-question-body pt-40px">
                      ...
                      <form:form method="post" action="/user/question" class="pt-4" modelAttribute="question">
                        <form:input type="hidden" path="course.id" value="${course.id}"/>
                        <form:input type="hidden" path="instructor.id" value="${course.instructor.id}"/>
                        <div class="custom-control-wrap">
                          <div class="custom-control custom-radio mb-3 pl-0">
                            <form:input type="text" path="subject" class="form-control form--control pl-3" />
                          </div>
                          <div class="custom-control custom-radio mb-3 pl-0">
                            <form:textarea class="form-control form--control pl-3" path="quest" rows="4" placeholder="Write your response..."></form:textarea>
                          </div>
                        </div>
                  ...
                  <div class="question-overview-result-wrap">
                    <div class="lecture-overview-item">
                      <div class="question-overview-result-header d-flex align-items-center justify-content-between">
                        <h3 class="fs-17 font-weight-semi-bold">${allQuestions.size()} questions in this course</h3>
                      ...
                      <div class="question-list-item">
                        ...
                        <div class="media media-card border-bottom border-bottom-gray py-4 px-3">
                          <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                            <img class="rounded-full" src="${empty question.user.photo ? '/upload/no_image.jpg' : '/admin/images/avatars/' + question.user.photo}" alt="User image">
                          </div>
                          <div class="media-body">
                            <div class="d-flex align-items-center justify-content-between">
                              <div class="question-meta-content">
                                <a href="javascript:void(0)" class="d-block">
                                  <h5 class="fs-16 pb-1">${question.subject} </h5>
                            ...
                            <p class="meta-tags pt-1 fs-13">
                              <span>${question.sentTime}</span>
                            </p>
                          </div><!-- end media-body -->
                        </div><!-- end media -->


                          <c:forEach var="rep" items="${question.replies}" varStatus="status">
                        <div class="media media-card border-bottom border-bottom-gray py-4 px-3" style="background: #e6e6e6">
                          <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                            <img class="rounded-full" src="${empty question.instructor.photo ? '/upload/no_image.jpg' : '/admin/images/avatars/' + question.instructor.photo}" alt="User image">
                          </div>
                          <div class="media-body">
                            <div class="d-flex align-items-center justify-content-between">
                              <div class="question-meta-content">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-6">
                <div class="client-logo-wrap text-right">
                  <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="/client/images/sponsor-img.png" alt="brand image"></a>
                  <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="/client/images/sponsor-img2.png" alt="brand image"></a>
                  <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="/client/images/sponsor-img3.png" alt="brand image"></a>
            ...
            <div class="row">
              <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                  <a href="index.html">
                    <img src="/client/images/logo.png" alt="footer logo" class="footer__logo">
                  </a>
              ...
              <div class="col-lg-3 responsive-column-half">
                <div class="footer-item">
                  ...
                  <div class="mobile-app">
                    ...
                    <a href="#" class="d-block mb-2 hover-s"><img src="/client/images/appstore.png" alt="App store" class="img-fluid"></a>
                    <a href="#" class="d-block hover-s"><img src="/client/images/googleplay.png" alt="Google play store" class="img-fluid"></a>
                  </div>
                </div><!-- end footer-item -->
              </div><!-- end col-lg-3 -->
            </div><!-- end row -->
      ...
      <div class="course-dashboard-sidebar-column">
        ...
        <div class="course-dashboard-sidebar-wrap custom-scrollbar-styled">
          ...
          <div class="course-dashboard-side-content">
            ...
            <c:forEach var="sec" items="${courseSections}" varStatus="status">
              ...
              <div class="card">
                <div class="card-header" id="headingOne${sec.id}">
                  <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne${sec.id}" aria-expanded="true" aria-controls="collapseOne">
                    <i class="la la-angle-down"></i>
                    <i class="la la-angle-up"></i>
                    <span class="fs-15"> ${sec.sectionTitle}</span>
                    <span class="course-duration">
                <span>${sec.lectures.size()}</span>
            </span>
                  </button>
                </div><!-- end card-header -->
                <div id="collapseOne${sec.id}" class="collapse " aria-labelledby="headingOne${sec.id}" data-parent="#accordionCourseExample">
                  <div class="card-body p-0">
                    <ul class="curriculum-sidebar-list">
              <c:forEach var="lect" items="${sec.lectures}" varStatus="status">
                      <li class="course-item-link active">
                        <div class="course-item-content-wrap">
                          <div class="custom-control custom-checkbox">
                          ...
                          <div class="course-item-content">
                            <h4 class="fs-15 lecture-title" data-video-url="${lect.url}" data-content="${lect.content}">${lect.lectureTitle}</h4>
                          </div><!-- end course-item-content -->
                        </div><!-- end course-item-content-wrap -->
                      </li>
              </c:forEach>
