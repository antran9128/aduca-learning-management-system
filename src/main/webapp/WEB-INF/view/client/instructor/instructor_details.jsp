    ...
    <div class="breadcrumb-content">
      <div class="media media-card align-items-center pb-4">
        <div class="media-img media--img media-img-md rounded-full">
          <img class="rounded-full" src="${empty instructor.photo ? '/upload/no_image.jpg' : '/upload/user/' + instructor.id + '/' + instructor.photo}" alt="Student thumbnail image">
        </div>
        <div class="media-body">
          <h2 class="section__title fs-30">${instructor.name}</h2>
          <span class="d-block lh-18 pt-1 pb-2">Joined ${instructor.joinedTime}</span>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 responsive-column-half">
          <div class="counter-item">
            ...
            <h4 class="counter__title counter text-color-4 fs-35">${courses.size()}</h4>
...
<section class="course-area section-padding">
  <div class="container">
    <div class="d-flex align-items-center justify-content-between pb-3">
      ...
      <span class="ribbon ribbon-lg">${courses.size()}</span>
    </div>
      ...
      <div class="col-lg-4 responsive-column-half">
        <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1${course.id}">
          ...
          <div class="card-body">
            ...
            <p class="card-text"><a href="/instructor/details/${instructor.id}">${instructor.name}</a></p>
