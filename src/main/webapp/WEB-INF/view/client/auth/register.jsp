                        ...
                        <div class="row">
                            <div class="col-lg-7 mx-auto">
                                <div class="card card-item">
                                    <div class="card-body">
                                        <h3 class="card-title text-center fs-24 lh-35 pb-4">Create an Account and <br>
                                            Start Learning!</h3>
                                        <div class="section-block"></div>
                                        <form:form method="post" class="pt-4" action="/register"
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <form:input
                                                        class="form-control form--control ${not empty errorFirstName ? 'is-invalid' : ''}"
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <form:input
                                                        class="form-control form--control ${not empty errorLastName ? 'is-invalid' : ''}"
                                                        type="text" path="lastName" placeholder="Last name" />
                                                    <span class="la la-user input-icon"></span>
                                                    ${errorLastName}
                                                </div>
                                            </div><!-- end input-box -->
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <form:input
                                                        ...
                                                        type="text" path="username" placeholder="Username" />
                                                    <span class="la la-user input-icon"></span>
                                                    ${errorUsername}
                                                </div>
                                            </div><!-- end input-box -->
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <form:input
                                                        ...
                                                        type="email" path="email" placeholder="Enter email address" />
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <form:input
                                                        class="form-control form--control password-field ${not empty errorPassword ? 'is-invalid' : ''}"
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="la la-lock input-icon"></span>
                                                    <form:input
                                                        class="form-control form--control password-field ${not empty errorConfirmPassword ? 'is-invalid' : ''}"
                                            ...
                                            <div class="btn-box">
                                                <div class="custom-control custom-checkbox mb-2 fs-15">
                                                    ...
                                                    <label class="custom-control-label custom--control-label lh-20"
                                                        for="receiveCheckbox">Yes! I want to get the most out of
                                                        Aduca
                                                        by receiving emails with exclusive deals, personal
                                                        recommendations and learning tips!</label>
