...
================================= -->
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center">
                            ...
                            <h4 class="modal-title fs-19 font-weight-semi-bold pt-2 pb-1" id="deleteModalTitle">Your
                                account will be deleted permanently!</h4>
            ...
            <!-- template js files -->
            <script href="/client/js/jquery-3.4.1.min.js"></script>
            <script href="/client/js/bootstrap.bundle.min.js"></script>
            <script href="/client/js/bootstrap-select.min.js"></script>
            <script href="/client/js/owl.carousel.min.js"></script>
            <script href="/client/js/isotope.js"></script>
            <script href="/client/js/jquery.counterup.min.js"></script>
            <script href="/client/js/fancybox.js"></script>
            <script href="/client/js/chart.js"></script>
            <script href="/client/js/doughnut-chart.js"></script>
            <script href="/client/js/bar-chart.js"></script>
            <script href="/client/js/line-chart.js"></script>
            <script href="/client/js/datedropper.min.js"></script>
            <script href="/client/js/emojionearea.min.js"></script>
            <script href="/client/js/animated-skills.js"></script>
            <script href="/client/js/jquery.MultiFile.min.js"></script>
            <script href="/client/js/main.js"></script>
