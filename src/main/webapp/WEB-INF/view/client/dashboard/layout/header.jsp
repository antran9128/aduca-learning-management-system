                                        ...
                                        <form method="post" class="mr-auto ml-0">
                                            <div class="form-group mb-0">
                                                <input class="form-control form--control form--control-gray pl-3"
                                                    type="text" name="search" placeholder="Search for anything">
                                                                ...
                                                                <li>
                                                                    <div class="media media-card">
                                                                        ...
                                                                        <div class="media-body">
                                                                            <h5><a href="course-details.html">The
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul
                                                                ...
                                                                <li class="menu-heading-block">
                                                                    <a href="dashboard.html"
                                                                        class="btn theme-btn w-100">Show All
                                                                        Notifications <i
                                                                            class="la la-arrow-right icon ml-1"></i></a>
                                                                </li>
                                                            </ul>
                                                                ...
                                                                <li
                                                                    ...
                                                                    <div class="ml-2">
                                                                        <h4><a href="teacher-detail.html"
                                                                                class="text-black">${name}</a></h4>
                                                                        <span
                                                                            class="d-block fs-14 lh-20">${email}</span>
                                                                    </div>
                                                                </li>
                                                                    ...
                                                                    <ul class="generic-list-item">
                                                                        ...
                                                                        <li>
                                                                            <a href="student-detail.html">
                                                                                <i class="la la-user mr-1"></i> Public
                                                                                profile
                                                                            </a>
                                                                        </li>
                                                                        <li>
