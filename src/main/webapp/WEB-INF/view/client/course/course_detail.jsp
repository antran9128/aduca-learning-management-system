      ...
      <div class="col-lg-8 mr-auto">
        <div class="breadcrumb-content">
          <ul class="generic-list-item generic-list-item-arrow d-flex flex-wrap align-items-center">
            ...
            <li><a href="#">${course.category.categoryName}</a></li>
            <li><a href="#">${course.subCategory.subcategoryName}</a></li>
          </ul>
          <div class="section-heading">
            <h2 class="section__title">${course.courseName}</h2>
            <p class="section__desc pt-2 lh-30">${course.courseTitle}</p>
          ...
          <div class="d-flex flex-wrap align-items-center">
            <p class="pr-3 d-flex align-items-center">
              ...
              Last updated <fmt:formatDate value="${course.createdAt}" pattern="MMM dd yyyy"/>
            </p>
            <p class="pr-3 d-flex align-items-center">
        ...
        <div class="col-lg-8 pb-5">
          <div class="course-details-content-wrap pt-90px">
            ...
            <div class="course-overview-card border border-gray p-4 rounded">
              ...
              <div class="pb-3">
                <img width="85" class="mr-3" src="/client/images/sponsor-img.png" alt="company logo">
                <img width="80" class="mr-3" src="/client/images/sponsor-img2.png" alt="company logo">
                <img width="80" class="mr-3" src="/client/images/sponsor-img3.png" alt="company logo">
                <img width="70" class="mr-3" src="/client/images/sponsor-img4.png" alt="company logo">
              </div>
            ...
            <div class="course-overview-card">
              <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                ...
                <div class="curriculum-duration fs-15">
                  <span class="curriculum-total__text mr-2"><strong class="text-black font-weight-semi-bold">Total:</strong> ${course.lectures.size()} lectures</span>
                ...
                <div class="media media-card">
                  <div class="instructor-img">
                    <a href="teacher-detail.html" class="media-img d-block">
                      <img class="lazy" src="${not empty course.instructor.photo ? '/admin/images/avatars/' + course.instructor.id + '/' + course.instructor.photo : '/admin/images/avatars/no_image.jpg'}" data-src="images/small-avatar-1.jpg" alt="Avatar image">
                    </a>
          ...
          <div class="sidebar sidebar-negative">
              ...
              <div class="card-body">
                <div class="preview-course-video">
                  <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                    <img src="/upload/course/thumbnail/${course.id}/${course.courseImage}" data-src="/upload/course/thumbnail/${course.id}/${course.courseImage}" alt="course-img" class="w-100 rounded lazy">
                  ...
                  <p class="d-flex align-items-center pb-2">
                    <c:choose>
                      <c:when test="${course.discountPrice == null}">
                        <span class="fs-35 font-weight-semi-bold text-black">${course.sellingPrice}</span>
                      </c:when>
                      <c:otherwise>
                        <span class="fs-35 font-weight-semi-bold text-black">${course.discountPrice }</span>
                        <span class="before-price mx-1">${course.sellingPrice}</span>
                      </c:otherwise>
                    </c:choose>
                    <span class="price-discount">${course.discountPercent}% off</span>
                  </p>
            ...
            <div class="card card-item">
              <div class="card-body">
                ...
                <div class="divider"><span></span></div>
                <c:forEach var="course" items="${suggestedCourses}" varStatus="status">
                  <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                    <a href="course-details.html" class="media-img">
                      <img class="mr-3 lazy" src="/upload/course/thumbnail/${course.id}/${course.courseImage}" data-src="/upload/course/thumbnail/${course.id}/${course.courseImage}" alt="Related course image">
                    </a>
                    <div class="media-body">
                      <h5 class="fs-15"><a href="course-details.html"> ${course.courseName}</a></h5>
                      <span class="d-block lh-18 py-1 fs-14">${course.instructor.name}</span>
                      <c:choose>
                        <c:when test="${course.discountPrice == null}">
                          <p class="text-black font-weight-semi-bold lh-18 fs-15">${course.sellingPrice}  </p>
                        </c:when>
                        <c:otherwise>
                          <p class="text-black font-weight-semi-bold lh-18 fs-15">${course.discountPrice} <span class="before-price fs-14">${course.sellingPrice}</span></p>
                        </c:otherwise>
                      </c:choose>
        ...
        <div class="modal-body">
          <div class="copy-to-clipboard">
            ...
            <div class="input-group">
              <input type="text" class="form-control form--control copy-input pl-3" value="http://localhost:8080/${pageContext.request.requestURI}">
      ...
      <div class="modal-content">
        <div class="modal-header border-bottom-gray">
          <div class="pr-2">
            ...
            <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle">${course.courseName}</h5>
          </div>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" class="la la-times"></span>
          </button>
        ...
        <div class="modal-body">
          <video controls crossorigin playsinline poster="/upload/course/thumbnail/${course.id}/${course.courseImage}" id="player">
            <!-- Video files -->
