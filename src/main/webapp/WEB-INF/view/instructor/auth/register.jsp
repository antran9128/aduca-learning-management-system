    ...
    <div class="row pt-50px">
      <div class="col-lg-10 mx-auto">
        <div class="card card-item">
          <div class="card-body">
            <form:form method="post" action="/become/instructor"
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="firstName" class="form-control form--control  ${not empty errorFirstName ? 'is-invalid' : ''}" type="text"  placeholder="e.g. Alex"/>
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="lastName" class="form-control form--control  ${not empty errorLastName ? 'is-invalid' : ''}" type="text"  placeholder="e.g. Alex"/>
                  <span class="la la-user input-icon"></span>
                  ${errorLastName}
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="username" class="form-control form--control  ${not empty errorUsername ? 'is-invalid' : ''}" type="text" />
                  <span class="la la-user input-icon"></span>
                  ${errorUsername}
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="email" class="form-control form--control  ${not empty errorEmail ? 'is-invalid' : ''}" type="email" />
                  <span class="la la-user input-icon"></span>
                  ${errorEmail}
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="phone" class="form-control form--control" type="text"  />
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-6">
                ...
                <div class="form-group">
                  <form:input path="address" class="form-control form--control" type="text"  />
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-12">
                ...
                <div class="form-group">
                  <form:input path="password" class="form-control form--control ${not empty errorPassword ? 'is-invalid' : ''}" type="password" />
                  <span class="la la-user input-icon"></span>
                  ${errorPassword}
                </div>
              </div><!-- end input-box -->
              ...
              <div class="input-box col-lg-12">
                ...
                <div class="form-group">
                  <form:input path="confirmPassword" class="form-control form--control ${not empty errorConfirmPassword ? 'is-invalid' : ''}" type="password" />
                  <span class="la la-user input-icon"></span>
