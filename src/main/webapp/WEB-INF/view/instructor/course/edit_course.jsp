      ...
      <div class="card">
        <div class="card-body p-4">
          ...
          <form:form action="/instructor/update/course" method="post" class="row g-3" enctype="multipart/form-data"
            ...
            <form:input type="hidden" path="instructor.id"/>
            ...
            <div class="form-group col-md-6">
              ...
              <form:select path="subCategory.id" id="subcategory" class="form-select mb-3"
                ...
                <option selected="" disabled>Open this select menu</option>
                <form:options items="${subcategories}" itemValue="id" itemLabel="subcategoryName"/>
              </form:select>
            </div>
                  ...
                  <div class="container mt-2">
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <form:input type="text" path="courseGoals[${counter}]" id="goals" class="form-control" placeholder="Goals "/>
                      </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    var counter = ${counter}; // Start counter at 1 since we already have [0]
